...
static bool ImGui_ImplSDL3_Init(SDL_Window* window, Renderer* renderer, void* sdl_gl_context)
{
    ImGuiIO& io = ImGui::GetIO();
    IMGUI_CHECKVERSION();
...
bool ImGui_ImplSDL3_InitForSDLRenderer(SDL_Window* window, Renderer* renderer)
{
